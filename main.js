...
function getSessStgItems(itemType) {
    // Get items from session storage for the specified item type
...
function pickFromModal_Items(elemModal, sessStgItemName) {
    // Pick and copy to clipboard and session storage the selected item from the modal
...
function removeFromModal_Items(elemModal, itemType) {
    // Remove the item from session storage as well
...
function removeItemFromSessStg(itemType, itemData) {
    // Remove the selected item from session storage
